          ...
          <Col key={coupon.serialNum} lg={2}>
            <Card style={{ width: "18rem" }}>
              ...
              <ListGroup className="list-group-flush">
                ...
                <ListGroup.Item>
                  Usage status: 
                  {coupon.usageStatus && <Badge bg="danger" className="mx-2">사용 불가능</Badge>}
                  {!coupon.usageStatus && <Badge bg="primary" className="mx-2">사용 가능</Badge>}
                </ListGroup.Item>
                <ListGroup.Item>
                  UsedDate:{coupon.usedDate && `${coupon.usedDate}`}
                </ListGroup.Item>
              </ListGroup>
              <Card.Body>
                <Card.Text
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    navigate(`/admin/coupon-detail/${index}`);
                  }}
                >
                  상세페이지
                </Card.Text>
